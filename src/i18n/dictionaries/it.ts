...
const it: Landing = {
  ...
  modulesSection: {
    ...
    subtitle:
      "Cinque moduli integrati che comunicano tra loro e mantengono tutta la selezione in un unico flusso.",
  },
  modules: [
    {
      title: "Workspaces",
      desc: "Organizza ogni azienda o team nel proprio workspace e passa dall'uno all'altro quando vuoi.",
    },
    {
      title: "Posizioni",
  ...
  cta: {
    title: "Inizia a reclutare in modo più intelligente",
    subtitle: "Accedi con il tuo account e ottieni accesso immediato a tutta la piattaforma.",
  },
  footer: {
    description:
      "Lumni sviluppa sistemi, automatizza processi e integra ingegneri nel tuo team. Dalla prima analisi al codice in produzione.",
