...
const ru: Admin = {
  ...
  plan: {
    ...
    limitProcesses:
      "Достигнут лимит процессов на компанию в вашем тарифе. Обновите тариф, чтобы добавить больше.",
    limitMembers:
      "Достигнут лимит сотрудников на компанию в вашем тарифе. Обновите тариф, чтобы пригласить больше.",
