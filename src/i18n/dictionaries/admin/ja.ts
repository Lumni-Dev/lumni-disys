...
const ja: Admin = {
  ...
  careers: {
    ...
    consent: "採用選考のために個人データが処理されることに同意します。",
    consentPolicy: "プライバシーポリシー",
    consentRequired: "応募するにはデータ処理への同意が必要です。",
    empty: "求人が見つかりません。",
  ...
  dataRights: {
    title: "マイデータ",
    subtitle: "候補者データのエクスポートまたは削除をリクエストします。",
    emailLabel: "メールアドレス",
    exportOption: "データをエクスポート",
    deleteOption: "データを削除",
    submit: "リクエストを送信",
    sent: "このメールに紐づくデータがある場合、確認リンクを送信しました。受信箱（と迷惑メール）をご確認ください。",
    confirmTitle: "リクエストの確認",
    confirmDelete: "削除を確認",
    exportDownload: "データをダウンロード",
    invalid: "リンクが無効か期限切れです。もう一度リクエストしてください。",
    deleted: "完了しました。データを削除しました。",
  },
  login: {
