...
const ko: Admin = {
  ...
  dataRights: {
    title: "내 데이터",
    subtitle: "지원자 데이터의 내보내기 또는 삭제를 요청하세요.",
    emailLabel: "이메일",
    exportOption: "내 데이터 내보내기",
    deleteOption: "내 데이터 삭제",
    submit: "요청 보내기",
    sent: "이 이메일과 연결된 데이터가 있으면 확인 링크를 보냈습니다. 받은편지함(및 스팸)을 확인하세요.",
    confirmTitle: "요청 확인",
    confirmDelete: "삭제 확인",
    exportDownload: "내 데이터 다운로드",
    invalid: "링크가 유효하지 않거나 만료되었습니다. 다시 요청하세요.",
    deleted: "완료! 데이터가 삭제되었습니다.",
  },
  login: {
