...
const pt: Admin = {
  ...
  careers: {
    ...
    consent: "Concordo com o tratamento dos meus dados pessoais para fins de recrutamento e seleção.",
    consentPolicy: "Política de Privacidade",
    consentRequired: "É necessário aceitar o tratamento dos dados para se candidatar.",
    empty: "Nenhuma vaga encontrada.",
    namePlaceholder: "Ex.: Ana Ribeiro",
  ...
  dataRights: {
    ...
    subtitle: "Solicite a exportação ou a exclusão dos seus dados de candidato.",
    emailLabel: "Seu e-mail",
    exportOption: "Exportar meus dados",
    deleteOption: "Excluir meus dados",
    submit: "Enviar solicitação",
    sent: "Se houver dados vinculados a este e-mail, enviamos um link de confirmação. Verifique sua caixa de entrada (e o spam).",
    confirmTitle: "Confirmar solicitação",
    confirmDelete: "Confirmar exclusão",
    exportDownload: "Baixar meus dados",
    invalid: "Link inválido ou expirado. Faça uma nova solicitação.",
    deleted: "Pronto! Seus dados foram excluídos.",
  },
  login: {
