...
const ar: Admin = {
  ...
  plan: {
    ...
    cancelDesc: "تحتفظ بـ Plus حتى نهاية الفترة المدفوعة.",
    resume: "استئناف الاشتراك",
    checkoutSuccess: "تم تفعيل الاشتراك! مرحبًا بك في Plus.",
  ...
  pipeline: {
    ...
    notify: "إخطار المرشحين عبر البريد الإلكتروني",
    notifyHint: "عند تغيير المرحلة أو الإضافة أو الإزالة، يتلقى المرشح بريداً إلكترونياً تلقائياً.",
    cols: {
      name: "المرشح",
      job: "الوظيفة",
      company: "الشركة",
  ...
  careers: {
    ...
    consent: "أوافق على معالجة بياناتي الشخصية لأغراض التوظيف.",
    consentPolicy: "سياسة الخصوصية",
    consentRequired: "يجب الموافقة على معالجة البيانات للتقديم.",
    empty: "لم يتم العثور على وظائف.",
  ...
  dataRights: {
    title: "بياناتي",
    subtitle: "اطلب تصدير أو حذف بيانات المرشح الخاصة بك.",
    emailLabel: "بريدك الإلكتروني",
    exportOption: "تصدير بياناتي",
    deleteOption: "حذف بياناتي",
    submit: "إرسال الطلب",
    sent: "إذا كانت هناك بيانات مرتبطة بهذا البريد، أرسلنا رابط تأكيد. تحقق من بريدك (والبريد المزعج).",
    confirmTitle: "تأكيد الطلب",
    confirmDelete: "تأكيد الحذف",
    exportDownload: "تنزيل بياناتي",
    invalid: "الرابط غير صالح أو منتهي الصلاحية. قدّم طلبًا جديدًا.",
    deleted: "تم! تم حذف بياناتك.",
  },
  login: {
