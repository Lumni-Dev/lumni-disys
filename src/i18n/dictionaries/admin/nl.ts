...
const nl: Admin = {
  ...
  dataRights: {
    title: "Mijn gegevens (AVG)",
    subtitle: "Vraag export of verwijdering van je kandidaatgegevens aan.",
    emailLabel: "Je e-mail",
    exportOption: "Mijn gegevens exporteren",
    deleteOption: "Mijn gegevens verwijderen",
    submit: "Verzoek versturen",
    sent: "Als er gegevens aan dit e-mailadres zijn gekoppeld, hebben we een bevestigingslink gestuurd. Controleer je inbox (en spam).",
    confirmTitle: "Verzoek bevestigen",
    confirmDelete: "Verwijdering bevestigen",
    exportDownload: "Mijn gegevens downloaden",
    invalid: "Ongeldige of verlopen link. Doe een nieuw verzoek.",
    deleted: "Klaar! Je gegevens zijn verwijderd.",
  },
  login: {
