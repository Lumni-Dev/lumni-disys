...
const fr: Admin = {
  ...
  dataRights: {
    ...
    subtitle: "Demandez l'export ou la suppression de vos données de candidat.",
    emailLabel: "Votre e-mail",
    exportOption: "Exporter mes données",
    deleteOption: "Supprimer mes données",
    submit: "Envoyer la demande",
    sent: "Si des données sont liées à cet e-mail, nous avons envoyé un lien de confirmation. Vérifiez votre boîte (et les spams).",
    confirmTitle: "Confirmer la demande",
    confirmDelete: "Confirmer la suppression",
    exportDownload: "Télécharger mes données",
    invalid: "Lien invalide ou expiré. Faites une nouvelle demande.",
    deleted: "Terminé ! Vos données ont été supprimées.",
  },
  login: {
