...
const de: Admin = {
  ...
  workspace: {
    ...
    editTitle: "Workspace umbenennen",
    editSubtitle: "Ändern Sie den Namen Ihres Workspace",
    title: "Meine Workspaces",
    subtitle: "Verwalten Sie Ihre Workspaces",
    searchPlaceholder: "Workspaces suchen...",
    active: "Aktiv",
    activate: "Öffnen",
    jobsCount: (n) => `${n} ${n === 1 ? "Stelle" : "Stellen"}`,
    empty: "Noch keine Workspaces",
    deleteBlocked: (n) =>
      `Löschen nicht möglich: ${n} ${n === 1 ? "verknüpfte Stelle" : "verknüpfte Stellen"}.`,
    deleteMessage:
      "Möchten Sie diesen Workspace wirklich löschen? Diese Aktion ist unwiderruflich.",
  },
  plan: {
    title: "Tarif",
  ...
  dataRights: {
    ...
    subtitle: "Fordern Sie den Export oder die Löschung Ihrer Bewerberdaten an.",
    emailLabel: "Ihre E-Mail",
    exportOption: "Meine Daten exportieren",
    deleteOption: "Meine Daten löschen",
    submit: "Anfrage senden",
    sent: "Falls Daten mit dieser E-Mail verknüpft sind, haben wir einen Bestätigungslink gesendet. Prüfen Sie Ihr Postfach (und Spam).",
    confirmTitle: "Anfrage bestätigen",
    confirmDelete: "Löschung bestätigen",
    exportDownload: "Meine Daten herunterladen",
    invalid: "Ungültiger oder abgelaufener Link. Bitte neu anfragen.",
    deleted: "Fertig! Ihre Daten wurden gelöscht.",
  },
  login: {
